...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { description: @attachment.description, owner_id: @attachment.owner_id, title: @attachment.title } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { description: @attachment.description, mime_type: @attachment.mime_type, owner_id: @attachment.owner_id, title: @attachment.title } }
