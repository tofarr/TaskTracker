class CreateTaskSearches < ActiveRecord::Migration[5.2]
  def change
    ...
    create_join_table(:task_searches, :user_tags, table_name: "task_searches_created_user_tags", on_delete: :cascade)
    create_join_table(:task_searches, :user_tags, table_name: "task_searches_assigned_user_tags", on_delete: :cascade)
    create_join_table(:task_searches, :users, table_name: "task_searches_created_users", on_delete: :cascade)
    ...
    add_index(:task_searches_created_user_tags, [:task_search_id, :user_tag_id], :unique => true, :name => 'idx_task_searches_created_user_tags')
    ...
    add_index(:task_searches_created_users, [:task_search_id, :user_id], :unique => true, :name => 'idx_task_searches_created_users')
